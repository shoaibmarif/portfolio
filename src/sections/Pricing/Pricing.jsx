...
export const Pricing = () => {
    return (
        <ContentWrapper classes={"w-full min-h-[70vh] py-16"}>
            ...
            <div className='grid grid-cols-6 gap-16 z-10 relative py-10 '>
                {pricing.map((price, index) => {
                    return (
                        <div key={price.plan} className={` cursor-pointer  relative col-span-6 lg:col-span-2   rounded-lg overflow-hidden bg-[#1f1f1f] text-white duration-500  shadow-[4px_4px_0px_#6d28d9] hover:shadow-[7px_7px_0px_#6d28d9]   transition-all ${index == 1 ? " lg:scale-110" : ""}`}>
                            {/* Header  */}
