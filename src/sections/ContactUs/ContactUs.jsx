        ...
        <ContentWrapper classes={"py-16"}>
            ...
            <div className="grid grid-cols-6 gap-12 mt-16 ">
                ...
                <div className='col-span-6 lg:col-span-3 lg:ml-auto'>
                    <div className="min-w-[100%] lg:min-w-[400px] items-center bg-[#1f1f1f] justify-center flex flex-col  rounded-xl py-10 px-8 shadow-[0px_0px_2px_0px_#dedede]" data-aos="zoom-in" data-aos-duration="700">
