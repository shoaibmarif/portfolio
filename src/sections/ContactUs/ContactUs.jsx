        ...
        <ContentWrapper classes={"py-16"}>
            ...
            <div className="grid grid-cols-5 gap-12 mt-16 ">
                <div className='col-span-3 text-[15px] dark:text-white text-[#0c0c0c]  pb-10'>
                    ...
                    <div className=" flex flex-col items-start justify-between" data-aos="fade-up" data-aos-duration="700">
                        <div className="flex items-center  dark:text-white text-[#0c0c0c]">
                            ...
                            <div className='ml-5'>
                                <a href="mailto:shoaibmuhammadarif@gmail.com">
                                    <h3 className="font-semibold text-primary-dark uppercase text-xl">Contact me by Email</h3>
                                    <span className=" inline-flex items-center gap-x-2 text-[15px] font-medium ">
                        ...
                        <div className="flex items-center justify-start dark:text-white text-[#0c0c0c]">
                            ...
                            <div className='ml-5'>
                                <a href="tel:+923357591625">
                                    <h3 className="font-semibold text-primary-dark uppercase text-xl">Contact me by Number</h3>
                                    <span className=" inline-flex items-center gap-x-2 text-[15px] font-medium ">
                                        +92-335-7591625
                                    </span>
                                </a>
                ...
                <div className='col-span-2 ml-auto'>
                    <div className="min-w-[400px] items-center bg-[#1f1f1f] justify-center flex flex-col  rounded-xl py-10 px-8 shadow-[0px_0px_2px_0px_#dedede]" data-aos="zoom-in" data-aos-duration="700">
