...
export const Service = ({ service, index }) => {
  ...
  return (
    <div
      ...
      >
        <span className=" text-xl lg:text-2xl font-semibold  uppercase text-center text-primary-dark">
          {service.title}
        </span>
        <span className="mt-4 lg:mt-8 text-[13px] md:text-[14px] lg:text-[15px]  inline-block ">{service.text}</span>
