...
export const Service = ({ service, index }) => {
        ...
        return (
                <div data-aos="zoom-in" data-aos-duration={duration} className=" shadow-[1px_1px_5px_0px_#ba9eff]  bg-white  min-h-[300px] flex items-center relative justify-center overflow-hidden flex-col p-10 rounded-xl mt-14 cursor-pointer group ">
