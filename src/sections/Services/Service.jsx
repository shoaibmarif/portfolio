...
export const Service = ({ service }) => {
        return (
                <div className=" bg-white  min-h-[300px] flex items-center relative justify-center overflow-hidden flex-col p-10 rounded-xl mt-14 cursor-pointer group shadow-md shadow-[#d7c8fc85]">
